  ...
  return (
    <div className="propos">
      <div className="Divpropos">
        ...
        <p className="proposP">
          Développer la scène compétitive Hearthstone à travers l’organisation
          de différents évènements (tournois communautaires, tournois rémunérés,
          etc.). Recruter des joueurs « espoirs », riches d’ambitions, afin de
          les pousser vers l’excellence. A plus long terme, devenir une
          structure référente sur Hearthstone.
        </p>
        <div className="proposImage1">
          <img
            className="Imagepropos1"
            src={roulanvipere}
            alt="Exemple Joueur"
          />
        </div>
        ...
        <p className="proposP">
          Nous avons commencé par recruter un staff afin d’assurer le bon
          développement de la structure. La suite logique fut le recrutement de
          joueurs prometteurs : Roulian, Logoss et Bongo, qui se qualifient
          régulièrement aux tournois mondiaux (Master Tour). Afin de rassembler
          notre communauté, nous avons organisé notre premier tournoi
          communautaire en juin 2021. En août, Bongo et Roulian auront
          l’occasion de représenter nos couleurs via leur participation au
          Master Tour Silvermoon.
        </p>

        <p className="proposP">
          Notre site web constitue l’accès direct à tous les réseaux sociaux de
          nos joueurs, mais également du staff, et bien évidemment de la
          structure. Notre Discord communautaire se développe à grande vitesse,
          ce qui va accélérer l’arrivée de nouveaux tournois et de nos concepts
          originaux.
        </p>

        <p className="proposP">
          Notre WebTV annoncera l’arrivée de streams réguliers, pour vous
          proposer un contenu audiovisuel, et vous faire connaître notre équipe
          et nos joueurs. Restez à l’affût des moindres informations !
        </p>
